...
//---------------------------------------------------------------------------
void __fastcall TFormGraphAlgorithm::FormCreate(TObject * Sender)    //顶点间初始设置为无穷大(不通)
{
    MG.vexnum = 0;
    MG.arcnum = 0;
...
//---------------------------------------------------------------------------
void __fastcall TFormGraphAlgorithm::CreateNodeBtClick(TObject * Sender)    //生成顶点按钮单击事件
{
...
void __fastcall TFormGraphAlgorithm::imgMouseDown(TObject * Sender, //鼠标按下事件,记录起始点的位置
        TMouseButton Button,
...
//---------------------------------------------------------------------------
void __fastcall TFormGraphAlgorithm::ShortestPathBtClick(TObject * Sender)    //最短路径求解事件
{
...
void __fastcall TFormGraphAlgorithm::DirectBtClick(TObject * Sender)
{
    direct = 1;
...
void __fastcall TFormGraphAlgorithm::NoDirectBtClick(TObject * Sender)
{
    direct = 0;
