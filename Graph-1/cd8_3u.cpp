...
void __fastcall TForm1::imgMouseDown(TObject * Sender,
        TMouseButton Button,
...
void __fastcall TForm1::phClick(TObject * Sender)	//最短路径求解事件
{
    ...
    ShowMessage("从原点到第 " + IntToStr(p) + " 点最佳路径为" +
            IntToStr(dte[p]));
    gb->Visible = true;
}
...
//---------------------------------------------------------------------------
void __fastcall TForm1::img1MouseDown(TObject * Sender, TMouseButton Button,  TShiftState Shift, int X, int Y)	//手绘画板上鼠标点下事件
{
    draw = true;
...
//---------------------------------------------------------------------------
void __fastcall TForm1::img1MouseMove(TObject * Sender, TShiftState Shift,  int X, int Y)	//手绘画板上鼠标移动事件
{
    if (draw)			//鼠标左键按下
...
//---------------------------------------------------------------------------
void __fastcall TForm1::img1MouseUp(TObject * Sender, TMouseButton Button,  TShiftState Shift, int X, int Y)	//手绘画板上鼠标弹起事件
{
    draw = false;		//中断绘图
